...
static void	init_brightness_box_children(t_engine *engine, t_gui_box *gui_box);
			...
			t_gui_box *parent)
{
	...
	*i += gui_box->size.y + OBJECT_ATTRIBUTE_BOX_OFFSET;
	init_brightness_box_children(engine, gui_box);
...
static void	init_brightness_box_children(t_engine *engine, t_gui_box *gui_box)
{
	...
	engine->gui.float_input_boxes.brightness = gui_box->children.data + 1;
