			...
			t_click_data click_data)
{
	...
	if (click_data.button != BUTTON_LEFT)
		return (position_input_box_z_on_click_text(self, engine, click_data));
...
void	position_input_box_z_on_click_text(t_gui_box *self, t_engine *engine,
			t_click_data click_data)
{
	if (click_data.button == SCROLL_UP)
	{
		click_data.button = BUTTON_LEFT;
		return (position_input_box_z_on_click_plus(self, engine, click_data));
	}
	if (click_data.button == SCROLL_DOWN)
	{
		click_data.button = BUTTON_LEFT;
		return (position_input_box_z_on_click_minus(self, engine, click_data));
	}
}
