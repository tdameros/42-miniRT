			...
			t_gui_box *gui_box)
{
	...
	if (gui_box->children.data == NULL)
		ft_fatal_error("init_cylinder_attributes_modification_box: "
			"malloc error");
...
static void	add_transformation_boxes(t_engine *engine, t_gui_box *gui_box)
{
	...
	add_radius_box(engine, gui_box->children.data + 2, &y, gui_box);
	add_height_box(engine, gui_box->children.data + 3, &y, gui_box);
}
...
static void	add_reflection_boxes(t_engine *engine, t_gui_box *gui_box)
{
	...
	add_reflection_box(engine, gui_box->children.data + 4, &y, gui_box);
	add_specular_reflection_box(engine, gui_box->children.data + 5, &y,
		gui_box);
}
...
static void	add_texture_boxes(t_engine *engine, t_gui_box *gui_box)
{
	...
	add_outline_checkerboard_size_box(engine, gui_box->children.data + 6,
		&y, gui_box);
